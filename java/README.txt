...
See the example org/clearsilver/test/CSTest.java for an example
of how to import and use the clearsilver objects.

USING in a servlet

Since the most common usage of Clearsilver is in a servlet, 
we've provided some examples of how to use it in the
org/clearsilver/examples/ directory.
